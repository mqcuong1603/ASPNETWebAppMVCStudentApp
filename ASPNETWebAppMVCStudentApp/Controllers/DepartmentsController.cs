...
namespace ASPNETWebAppMVCStudentApp.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartmentID,Name,Budget,StartDate")] Departments departments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DepartmentID,Name,Budget,StartDate")] Departments departments)
        {
            if (ModelState.IsValid)
            {
